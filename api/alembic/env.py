...
# Look in the api directory (parent of alembic directory)
# api_dir = os.path.dirname(os.path.dirname(__file__))
# env_file = os.getenv("DOTENV_FILE")
# if not env_file:
#     # Try .env.production first, then .env
#     prod_env = os.path.join(api_dir, ".env.production")
#     dev_env = os.path.join(api_dir, ".env")
...
#         env_file = os.path.join(api_dir, env_file)
# load_dotenv(env_file)
load_dotenv()

# Add the api directory to the path so we can import shared modules
