...
class LetterResponse(BaseModel):
    ...
    template_id: UUID | None = Field(
        default=None, description="Template ID used to generate the letter"
    )
    template_name: str | None = Field(default=None, description="Template name")
    source_documents: list[DocumentMetadata] = Field(
        default_factory=list, description="List of source document metadata"
    )
    docx_url: HttpUrl | None = Field(
        default=None, description="Presigned URL for downloading the .docx file"
    )
...
class LetterUpdate(BaseModel):
    ...
    title: str | None = Field(default=None, description="Letter title")
    content: str | None = Field(default=None, description="HTML content of the letter")
