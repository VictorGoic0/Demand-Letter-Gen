...
class ErrorResponse(BaseModel):
    ...
    detail: str | None = Field(default=None, description="Optional detailed error information")
...
class PaginationParams(BaseModel):
    ...
    sort_order: str | None = Field(default="asc", description="Sort order: 'asc' or 'desc'")
